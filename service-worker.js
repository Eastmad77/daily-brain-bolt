// ======================================================
// The Daily Brain ⚡ Bolt — Service Worker v3.8.1
// Fix: ensure latest app.js loads (network-first for core)
// ======================================================

const STATIC = 'tdbb-static-v3.8.1';
const RUNTIME = 'tdbb-runtime-v3.8.1';
...
self.addEventListener('fetch', (event) => {
  ...
  // ✅ Network-first for core files so new deployments actually load
